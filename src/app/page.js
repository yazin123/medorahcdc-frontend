...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Hero title='Where little minds grow, and big dreams begin!'
        description="Introducing Chengannur's first-ever Child Development Center—a nurturing space where we
                      work hand in hand, step by step, helping every child reach their milestones and beyond!"
        image='/kids.png'
      />
      <Features />
